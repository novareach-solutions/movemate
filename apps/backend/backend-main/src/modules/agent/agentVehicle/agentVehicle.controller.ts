import {
  ...
  import { AgentStatusEnum, ApprovalStatusEnum, UserRoleEnum } from "../../../shared/enums";
...
import { AgentVehicleService } from "./agentVehicle.service";
  ...
  export class AgentVehicleController {
    ...
    async createVehicle(
      ...
      const vehicle = await this.agentVehicleService.createVehicle(agentId, vehicleData);
      return {
        success: true,
    ...
    async updateVehicle(
      ...
      const agentId = request.user.agent.id;
      const result = await this.agentVehicleService.updateVehicle(agentId, vehicleId, updateData);
      return {
        success: true,
