...
export class SendAPackage1739339154837 implements MigrationInterface {
  name = "SendAPackage1739339154837";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE "agent" (
                ...
                "subscriptionStatus" character varying DEFAULT 'INACTIVE',
                "subscriptionExpiresAt" TIMESTAMP,
                "commissionRate" numeric(5, 2) NOT NULL DEFAULT '0.1',
    ...
    await queryRunner.query(`
            CREATE TABLE "send_package_order" (
                ...
                "payments" character varying NOT NULL DEFAULT 'NOT_PAID',
