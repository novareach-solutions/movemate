...
const DocumentsScreen: React.FC = () => {
    ...
    // Array for icons
    const iconsArray = [images.document1, images.document1, images.document1, images.document1];
    ...
    return (
        <View style={styles.container}>
            <View style={styles.documentList}>{documentsWithIcons.map(renderDocumentItem)}</View>
        </View>
    );
};
