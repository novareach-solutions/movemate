...
const PayoutScreen: React.FC = () => {
    const [selectedPayoutType, setSelectedPayoutType] = useState<'Instant' | 'Normal' | null>(null);
    const [selectedPaymentMethod, setSelectedPaymentMethod] = useState<'Visa' | null>(null);
        ...
        <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.sectionContainer}>
                    ...
                    <TouchableOpacity
                        style={[styles.optionContainer, selectedPaymentMethod === 'Visa' && styles.selectedOption]}
                    ...
                    >
                        ...
                        <View style={styles.checkbox}>{selectedPaymentMethod === 'Visa' && <View style={styles.checkboxInner} />}</View>
                    </TouchableOpacity>
                </View>

                {/* Note Section */}
                <Text style={styles.note}>
                    Once you confirm, the funds will usually be sent within minutes. However, please note that the
                    transfer time may vary and is not guaranteed.
                </Text>
            </ScrollView>
