...
const DropOffOrderDetailsScreen: React.FC = () => {
    ...
    const [isDeliveryModalVisible, setIsDeliveryModalVisible] = useState<boolean>(true);
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.openModalButton} onPress={handleOpenDeliveryModal}>
