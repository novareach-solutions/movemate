...
const AppLayoutScreen = () => {
    return (
        <Tab.Navigator
            ...
            <Tab.Screen options={{ tabBarLabel: "Home", }} name={CustomerScreens.HomeScreen} component={HomeScreen} />
            <Tab.Screen options={{ tabBarLabel: "Orders" }} name={CustomerScreens.OrderScreen} component={OrderScreen} />
            <Tab.Screen options={{ tabBarLabel: "Notifications" }}
                name={CustomerScreens.NotificationScreen}
                component={NotificationScreen}
            />
            <Tab.Screen options={{ tabBarLabel: "Account" }} name={CustomerScreens.AccountScreen} component={AccountScreen} />
        </Tab.Navigator>
    );
};
