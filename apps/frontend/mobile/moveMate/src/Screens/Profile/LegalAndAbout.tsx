      ...
      <View style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            MoveMate is your reliable, all-in-one solution for deliveries,
            towing, and moving services. Whether it's sending a package, buying
            from a store, or arranging home or vehicle transport, MoveMate
            ensures fast, secure, and hassle-free service. MoveMate is designed
            to make your life easier by offering 24/7 availability and a
            user-friendly interface. From scheduling services to tracking your
            orders in real-time, we prioritize convenience and efficiency,
            ensuring that every task is handled with care and professionalism.
          </Text>
        </View>
            ...
            <View
              style={[
                ...
                expandedSection === "Privacy Policy" &&
                  styles.accordionIndicatorRotated,
              ]}
            >
