...
const EnterLocationDetailsScreen = () => {
  ...
  const [isPackageTypeModalVisible, setIsPackageTypeModalVisible] =
    useState(false);
        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.subHeader}>
              Just Pack It, We'll Do the Rest
            </Text>
          </View>
          ...
          <View style={styles.stepsContainer}>
            ...
            <View style={styles.fieldsContainer}>
              ...
              <TouchableOpacity
                style={styles.singleFieldButton}
                onPress={openPackageTypeModal}
              >
                {packageType ? (
          ...
          <View style={styles.notesContainer}>
            <View style={styles.pickupNotes}>
              ...
              <Text style={styles.notesLabel}>
                Pickup Notes <Text style={styles.optionalText}>(optional)</Text>
              </Text>
            </View>
